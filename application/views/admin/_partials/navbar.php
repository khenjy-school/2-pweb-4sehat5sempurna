<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #A8F584;">
    ...
    <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
